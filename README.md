# poker44-miner-gen10heur2

Minimal release repository for model gen10heur2.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur2.git
cd poker44-miner-gen10heur2
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur2`.
